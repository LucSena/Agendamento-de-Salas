...
if (isset($_GET['acao']) && $_GET['acao'] == "invalidar") {
    $usuario_id = $_GET['id'];
    $atualizar = "UPDATE tb_usuarios SET nivel='0' WHERE id = '$usuario_id'";
    $atualizado = mysqli_query($link, $atualizar);

    if ($atualizado == true) {
        echo '<script>
        alert("Usuário foi invalidado com sucesso");
        location.href="administrador.php"
        </script>';
    }
}
        ...
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <a href="administrador.php" class="btn btn-success my-2">Usuarios não validados</a>
                </div>
            </div>
        </section>
        ...
        <div class="album py-5 bg-light">
            ...
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 salas">
                    <h4>Todos usuarios do sistema:</h4>
                    <?php
                            ...
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <div class="row d-flex justify-content-between align-items-center">
                                        ...
                                        ?>
                                        <small class="col text-muted"> <?php echo $mostrar['nome']; ?></small>
                                        <small class="col text-muted"> <?php echo $mostrar['email']; ?></small>
                                        <small class="col text-muted"> <?php echo $instituicao; ?></small>
                                        <div class="col btn-group">
                                            <a href="?acao=invalidar&id=<?php echo $mostrar['id']; ?>"><button type="button" class="btn btn-sm btn-outline-secondary">Invalidar</button></a>
